...
// -- отримати всі елементи з класом fc_rules. визначити їм 2 події "клік", одна вивдоить текст елементу, інша довільний ьексь
    ...
    classLists2Element.click = () => console.log(classLists2Element.textContent);
    classLists2Element.click = () => console.log(classLists2Element.innerHTML = 'Hello');
}
    // classLists2Element.onclick(function () {
    //        console.log(classLists2Element.innerText)}
    // classLists2Element.onclick(function () {
    //         console.log(`Hello`)}
    // });
